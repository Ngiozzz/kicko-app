-- Seeds the real, fully-designed HTML for every email template with
-- the copy built in docs/email templates/*.html — self-contained
-- documents (own inline SVG logo, MSO/Outlook-safe markup, full brand
-- palette), so use_wrapper is false for all of them: wrapping them in
-- the shared banner/footer (see wrapper() in email.service.ts) would
-- double up the logo and footer inside an already-complete page.
-- Upsert so re-running this migration after a design tweak just
-- refreshes the content instead of erroring on the existing rows.
                    ...
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad2" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      </defs>
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad2)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad2)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad2)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td align="center" style="padding: 4px 0 24px 0;">
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <!-- ring + hexagon mark, charcoal tile, gold gradient -->
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad7" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad7)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad7)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad7)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
                ...
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad3)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad3)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad3)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad9" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad9)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad9)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad9)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad16" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad16)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad16)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad16)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad12" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad12)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad12)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad12)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad11" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad11)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad11)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad11)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad10" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad10)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad10)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad10)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
                ...
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad4)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad4)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad4)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad8" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad8)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad8)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad8)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad5" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad5)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad5)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad5)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad6" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad6)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad6)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad6)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad17" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad17)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad17)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad17)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Organizers</span>
                  </td>
                </tr>
              </table>
            </td>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad14" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad14)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad14)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad14)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">Admin</span>
                  </td>
                </tr>
              </table>
            </td>
                ...
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad15)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad15)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad15)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="width:40px; padding-right:10px;">
                    <svg width="40" height="40" viewBox="0 0 400 400" xmlns="http://www.w3.org/2000/svg">
                      <defs>
                        <linearGradient id="ringGrad13" x1="0%" y1="0%" x2="100%" y2="100%">
                          <stop offset="0%" stop-color="#D9A857"/>
                          <stop offset="55%" stop-color="#E8C787"/>
                          <stop offset="100%" stop-color="#F3EFE6"/>
                        </linearGradient>
                      ...
                      <rect width="400" height="400" rx="88" fill="#1E2126"/>
                      <circle cx="200" cy="200" r="128" fill="none" stroke="url(#ringGrad13)" stroke-width="20"/>
                      <polygon points="200,80 298,140 298,260 200,320 102,260 102,140" fill="none" stroke="url(#ringGrad13)" stroke-width="20" stroke-linejoin="round"/>
                      <circle cx="200" cy="200" r="46" fill="none" stroke="url(#ringGrad13)" stroke-width="20"/>
                    </svg>
                  </td>
                  <td style="font-family: Georgia, 'Times New Roman', serif; font-size: 22px; font-weight: 700; color:#1E2126; letter-spacing: -0.3px;">
                    Kicko <span style="font-family: Arial, Helvetica, sans-serif; font-size: 12px; font-weight: 700; color:#5A5F66; letter-spacing: 0.3px; vertical-align: middle;">for Owners</span>
